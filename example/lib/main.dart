...
const String materialSymbolsIconsSourceFontVersionNumber = '2.784';  // must update for each new font update
const String materialSymbolsIconsSourceReleaseDate = 'August 22, 2024';  // must update for each new font update
