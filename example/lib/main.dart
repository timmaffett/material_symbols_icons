...
const String materialSymbolsIconsSourceFontVersionNumber = '2.785';  // must update for each new font update
const String materialSymbolsIconsSourceReleaseDate = 'September 5, 2024';  // must update for each new font update
