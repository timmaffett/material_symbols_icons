...
const String materialSymbolsIconsSourceFontVersionNumber = '2.762';  // must update for each new font update
const String materialSymbolsIconsSourceReleaseDate = 'June 6, 2024';  // must update for each new font update
