...
const String materialSymbolsIconsSourceFontVersionNumber = '2.719';  // must update for each new font update
const String materialSymbolsIconsSourceReleaseDate = 'Feb. 02, 2024';  // must update for each new font update
