...
const String materialSymbolsIconsSourceFontVersionNumber = '2.716';  // must update for each new font update
const String materialSymbolsIconsSourceReleaseDate = 'Jan. 11, 2024';  // must update for each new font update
